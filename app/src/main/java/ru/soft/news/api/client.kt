...
fun OkHttpClient.newsClient(headers: Map<String, String>,
...
private fun OkHttpClient.Builder.addLogger(
    logLevel: HttpLoggingInterceptor.Level): OkHttpClient.Builder {
